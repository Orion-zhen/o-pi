...
@media(max-width:600px){body{padding:22px 14px 40px}.header{display:block}.timestamp{text-align:left;margin-top:12px}.cards,.grid-3,.grid-4{grid-template-columns:repeat(2,minmax(0,1fr))}.panel{overflow-x:auto}table{min-width:700px}.split table{min-width:0}.panel-header{min-width:0}.error-popover{position:fixed;top:50%;right:auto;left:50%;width:min(230px,calc(100vw - 28px));transform:translate(-50%,-50%)}}
</style></head><body>
