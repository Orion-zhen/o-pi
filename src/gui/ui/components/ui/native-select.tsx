...
function NativeSelect({
	...
	return (
		...
		>
			...
			/>
			<ChevronDownIcon
				className="pointer-events-none col-start-2 row-start-1 mr-3.5 size-4 text-muted-foreground opacity-50 select-none"
				aria-hidden="true"
