...
function formatAssistantPerformance(performance: AssistantPerformance, hideThinking: boolean): string {
...
function readOutputPadding(component: UserMessageComponent | AssistantMessageComponent): number {
