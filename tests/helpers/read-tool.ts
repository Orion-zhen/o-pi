...
import type { InlineImageProcessor, ReadStructureSource } from "../../src/harness/file-tools/read/ports.ts";
import type { PdfDocumentSource } from "../../src/harness/media/pdf-types.ts";
