...
const schemaCases = [
	...
	},
	{
		...
		valid: [
			...
			{ path: "a.ts", lines: "1-2" },
			{ path: "a.ts", lines: "2-" },
			{ path: "doc.pdf", pages: "1-20" },
			{ path: "doc.pdf", pages: "1,3-5,9-" },
			{ path: "a.ts", lines: "1-2,5,9-" },
		],
		invalid: [
			{ path: "a.ts", lines: "" },
			{ path: "a.ts", lines: "01" },
			...
			{ path: "a.ts", lines: "1, 3" },
			{ path: "a.ts", lines: "1," },
			{ path: "a.ts", lines: "1,03" },
			{ path: "a.ts", pages: "1", lines: "1" },
			{ path: "a.ts", start_line: 1 },
			{ path: "a.ts", end_line: 2 },
