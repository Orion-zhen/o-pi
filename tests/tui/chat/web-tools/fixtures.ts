...
export function webFetchDetails(overrides: Partial<WebFetchSuccessDetails> = {}): WebFetchSuccessDetails {
	return {
		...
		completeness: "partial", omissions: [{ kind: "embedded_content", reason: "iframe_not_fetched" }],
		...
		range: { kind: "read", start: 0, end: 1000, total: 3000, has_more: true, next_offset: 1000 },
